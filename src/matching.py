...
def match_sites(outages: list[dict[str, Any]], sites: list[dict[str, Any]]) -> list[dict[str, Any]]:
    """Her kesinti için yalnızca poligonla coğrafi olarak çakışan ve 15 km içindeki yakın sahaları döndürür. Adres eşleştirmesi kullanılmaz."""
